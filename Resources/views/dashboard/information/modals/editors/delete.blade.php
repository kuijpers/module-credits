<!-- Modal -->
<div class="modal fade" id="delete_editors_information" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <form method="POST" action="{{route('dashboard.credits.information.delete')}}">
            ...
            <input name="id" type="hidden" class="form-control span6" id="delete_editor_id">
