<!-- Modal -->
<div class="modal fade" id="approve_editors_information" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-success" id="exampleModalLongTitle">
                    <strong>
                        @lang('credits::modals.editor-approve')
                    </strong>
                </h5>
            ...
            <form method="POST" action="{{route('dashboard.credits.information.approve')}}">
                ...
                <div class="modal-body">
                    ...
                    <input name="id" type="hidden" class="form-control span6" id="approve_editor_id">

                    <input name="update_type" type="hidden" class="form-control span6" id="approve_editor_update_type" value="editor">
