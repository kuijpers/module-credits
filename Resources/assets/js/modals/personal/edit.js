$('#edit_personal_draft_information').on('show.bs.modal', function(e) {
	...
	article_id			=	$("#edit_personal_drafts_id");
	title_id			=	$("#edit_personal_drafts_title");
	description_id		=	$("#edit_personal_drafts_description");
	content_id			=	$("#edit_personal_drafts_content");
